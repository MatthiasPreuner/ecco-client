...
export const DeleteRepoModal: React.FC<{ repo: RepositoryModel }> = (props) => {
  ...
  return (
    <>
      <Button variant="secondary" disabled={props.repo == null} onClick={handleShow}>Delete Repository</Button>
